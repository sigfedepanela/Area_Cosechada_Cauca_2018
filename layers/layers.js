...
jsonSource_reaCosechadadeCaaPaneleraHectareas_2.addFeatures(features_reaCosechadadeCaaPaneleraHectareas_2);var lyr_reaCosechadadeCaaPaneleraHectareas_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/reaCosechadadeCaaPaneleraHectareas_2_0.png" />  10 - 220 <br />\
    <img src="styles/legend/reaCosechadadeCaaPaneleraHectareas_2_1.png" />  220 - 580 <br />\
    <img src="styles/legend/reaCosechadadeCaaPaneleraHectareas_2_2.png" />  580 - 900 <br />\
    <img src="styles/legend/reaCosechadadeCaaPaneleraHectareas_2_3.png" />  900 - 1940 <br />\
    <img src="styles/legend/reaCosechadadeCaaPaneleraHectareas_2_4.png" />  1940 - 3050 <br />'
        });
...
lyr_reaCosechadadeCaaPaneleraHectareas_2.set('fieldAliases', {'DEPARTAMEN': 'DEPARTAMEN', 'MUNICIPIO': 'MUNICIPIO', 'CULTIVO': 'CULTIVO', 'AÑO': 'AÑO', 'A.SEM.(Ha)': 'A.SEM.(Ha)', 'A.COS.(Ha)': 'A.COS.(Ha)', 'PROD.(Ton)': 'PROD.(Ton)', 'REND.(Ton/': 'REND.(Ton/', });
...
lyr_reaCosechadadeCaaPaneleraHectareas_2.set('fieldImages', {'DEPARTAMEN': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'CULTIVO': 'TextEdit', 'AÑO': 'TextEdit', 'A.SEM.(Ha)': 'TextEdit', 'A.COS.(Ha)': 'TextEdit', 'PROD.(Ton)': 'TextEdit', 'REND.(Ton/': 'TextEdit', });
...
lyr_reaCosechadadeCaaPaneleraHectareas_2.set('fieldLabels', {'DEPARTAMEN': 'inline label', 'MUNICIPIO': 'inline label', 'CULTIVO': 'inline label', 'AÑO': 'inline label', 'A.SEM.(Ha)': 'inline label', 'A.COS.(Ha)': 'inline label', 'PROD.(Ton)': 'inline label', 'REND.(Ton/': 'inline label', });
